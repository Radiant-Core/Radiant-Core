...
function(_gen_native_cmake_target)
	...
	if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
		...
		if(DEFINED Event_VERSION)
			string(APPEND ARGS " -DEvent_VERSION=${Event_VERSION}")
		endif()
		if(DEFINED Event_INCLUDE_DIR)
			string(APPEND ARGS " -DEvent_INCLUDE_DIR=${Event_INCLUDE_DIR}")
		endif()
		if(DEFINED Event_event_LIBRARY)
			string(APPEND ARGS " -DEvent_event_LIBRARY=${Event_event_LIBRARY}")
		endif()
	endif()
