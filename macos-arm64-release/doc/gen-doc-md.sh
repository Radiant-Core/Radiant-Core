...
cd "/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc"
rm -f mkdocs.yml
rm -rf md
mkdir md
...
find . \( \
  ...
  -print0 \
  | tar cf - --null -T - \
  | tar xf - --directory "/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc/md"
cd "/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc"
...
done < "/Users/main/Downloads/Radiant-Core-main/COPYING"
sed -i s/\]\(COPYING\)/\]\(COPYING.md\)/ md/README.md

# Generate command-line interface documentation.
mkdir -p md/doc/cli
"/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$(../src/radiantd -??)" > md/doc/cli/radiantd.md
if [ "Darwin" == "Darwin" ]; then
  "/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$("../src/qt/RadiantCore-Qt.app/Contents/MacOS/RadiantCore-Qt" -??)" > md/doc/cli/bitcoin-qt.md
else
  "/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$(../src/qt/bitcoin-qt -??)" > md/doc/cli/bitcoin-qt.md
fi
"/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$(../src/radiant-cli -?)" > md/doc/cli/radiant-cli.md
"/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$(../src/radiant-tx -?)" > md/doc/cli/radiant-tx.md
"/Users/main/Downloads/Radiant-Core-main/contrib/devtools/cli-help-to-markdown.py" "$(../src/seeder/radiant-seeder -?)" > md/doc/cli/radiant-seeder.md

# Start a regtest node in a temporary data directory.
mkdir -p md/doc/json-rpc/tmp
../src/radiantd -daemon -debuglogfile=0 -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages
...
while IFS= read -r line; do
  ...
  if [ "OFF" == "OFF" ] || [ "${line: -21}" != " doc/release-notes.md" ]; then
  ...
  if [ "${line: -23}" == " doc/json-rpc/README.md" ]; then
    ...
    ../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages help | while read -r helpline; do
      if [ -n "$helpline" ]; then
        if [[ "$helpline" =~ ^==[[:space:]](.*)[[:space:]]==$ ]]; then
          ...
          "/Users/main/Downloads/Radiant-Core-main/contrib/devtools/rpc-help-to-markdown.py" "$(../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages help $command)" > "md/doc/json-rpc/$command.md"
          {
              echo
              echo "***"
              echo
...
done < "/Users/main/Downloads/Radiant-Core-main/doc/mkdocs.yml.in"
# Stop the regtest node.
../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-arm64-release/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages stop
