...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "coins -> compressor -> primitives/transaction -> script/interpreter -> script/script_execution_context -> coins"
    "config -> policy/policy -> validation -> primitives/block -> key_io -> config"
    "crypto/common -> crypto/sha512_256 -> crypto/common"
)
