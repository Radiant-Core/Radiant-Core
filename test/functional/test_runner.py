...
def main():
    ...
    default_configfile = os.path.join(os.path.abspath(
        os.path.dirname(__file__)), "..", "config.ini")

    pre_parser = argparse.ArgumentParser(add_help=False)
    pre_parser.add_argument('--configfile', default=default_configfile,
                            help='Path to config.ini generated by the build system.')
    pre_args, _ = pre_parser.parse_known_args()

    configfile = pre_args.configfile
