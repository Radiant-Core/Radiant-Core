...
These are the dependencies currently used by Radiant Core. You can find
...
| OpenSSL | [3.0.18](https://www.openssl.org/source) |  | Yes |  |  | Crypto | Random Number Generation, Elliptic Curve Cryptography
| PCRE |  |  |  |  | Yes |  |  |
