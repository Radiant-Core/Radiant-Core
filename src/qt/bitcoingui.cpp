...
void BitcoinGUI::createActions() {
    ...
    overviewAction->setShortcut(QKeySequence(static_cast<int>(Qt::ALT) | static_cast<int>(Qt::Key_1)));
    ...
    sendCoinsAction->setShortcut(QKeySequence(static_cast<int>(Qt::ALT) | static_cast<int>(Qt::Key_2)));
    ...
    receiveCoinsAction->setShortcut(QKeySequence(static_cast<int>(Qt::ALT) | static_cast<int>(Qt::Key_3)));
    ...
    historyAction->setShortcut(QKeySequence(static_cast<int>(Qt::ALT) | static_cast<int>(Qt::Key_4)));
    ...
    quitAction->setShortcut(QKeySequence(static_cast<int>(Qt::CTRL) | static_cast<int>(Qt::Key_Q)));
...
void BitcoinGUI::createMenuBar() {
    ...
    minimize_action->setShortcut(QKeySequence(static_cast<int>(Qt::CTRL) | static_cast<int>(Qt::Key_M)));
