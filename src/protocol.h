...
/**
 * Maximum length of incoming protocol messages (2MB for most messages).
 * NB: Messages propagating block content and TX messages are not subject to this limit.
 * @see MAX_TX_MESSAGE_LENGTH for TX message limit.
 */
