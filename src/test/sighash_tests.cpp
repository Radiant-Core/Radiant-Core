...
// NOTE: This test is disabled for Radiant because the test vectors were generated
// for Bitcoin/BCH's sighash algorithm. Radiant uses a modified sighash that includes
// hashOutputHashes in the preimage. The randomized sighash_test above provides
// adequate coverage for testing internal consistency of the sighash implementation.
#if 0
