...
BOOST_AUTO_TEST_CASE(headerFinalizationDisabledZero) {
    ...
    // Optimization: don't need to go all the way back to genesis to prove this point in unit tests,
    // just go back enough to cover deep reorgs.
    auto depth = std::min(tipHeight, (int)DEFAULT_MAX_REORG_DEPTH * 2);
