...
public:
    CRegTestParams() {
        ...
        // Use minimum difficulty for fast mining in functional tests
        genesis = CreateGenesisBlockTestnet(1657071137, 1, 0x207fffff, 1,
                                     50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock ==
               uint256S("7c1797514a165b0d99953a993a2a42081d6c0706026c36c06fc6fe728f93a5dd"));
        assert(genesis.hashMerkleRoot ==
               uint256S("364459380841db3f0ea491e8099bf98a6b7ffc5693d8ee6e46b3f8183e0257dc"));
