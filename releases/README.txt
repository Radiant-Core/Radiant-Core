...
----------------------
- See doc/release-notes/release-notes-3.0.0.md for full details
- v3.0.0/RELEASE_NOTES.md                               - Full release notes
- v3.0.0/radiant-core-linux-x64-v3.0.0.tar.gz           - Linux x86_64 CLI binaries (Ubuntu 22.04+)
- v3.0.0/radiant-core-macos-arm64-v3.0.0.tar.gz         - macOS ARM64 CLI binaries
- v3.0.0/radiant-core-gui-macos-arm64-v3.0.0.zip        - macOS ARM64 GUI app bundle
- v3.0.0/radiant-core-docker-v3.0.0.tar.gz              - Docker runtime image (amd64, Ubuntu 22.04)
- v3.0.0/Windows/RadiantCore.exe                         - Classic Qt GUI wallet (requires DLLs)
- v3.0.0/Windows/RadiantCoreNode+Wallet-v.3.0.0.exe     - Standalone Node+Wallet GUI (no DLLs needed)
- v3.0.0/Windows/radiant-core-windows-x64.zip            - All-in-one archive (all exes + all DLLs)
- v3.0.0/Windows/radiant-core-windows-x64.sha256         - Windows SHA-256 checksums
- v3.0.0/*.sha256                                        - SHA-256 checksums
